...
def requisitando_dados(api):
    ...
    if len(dados_brutos) < 4:   
        dados_brutos_8331 = None
        dados_brutos_216 = None
        dados_brutos_214 = None
        dados_brutos_112 = None
...
#PARTE ESTADUAL
dados_limpos_8331, dados_limpos_216, dados_limpos_214, dados_limpos_112 = executando_dados('estadual')
...
dados_limpos_8331_muni, dados_limpos_216_muni, dados_limpos_214_muni, dados_limpos_112_muni = executando_dados('muni')
